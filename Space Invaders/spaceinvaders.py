...
pygame.display.set_caption("Space Invadah")


enemy_img = pygame.image.load("images/NORMAL.jpg")
bullet_img = pygame.image.load("images/NORMAL.jpg")
boss_img = pygame.image.load("images/Final Boss.jpeg")
background = pygame.image.load("images/Spaceship.jpg")
...
class Player:
    def __init__(self):
        self.image = pygame.transform.scale(player_img, (150, 150))
        self.x = WIDTH // 2 - 25
        self.y = HEIGHT - 150
        self.speed = 6
        self.health = 100
...
class Enemy:
    def __init__(self, x, y):
        self.image = pygame.transform.scale(enemy_img, (100, 100))
        self.y = y
        self.x = x
        self.speed = 3
        self.direction = 1
...
class Bullet:
    def __init__(self, x, y, speed=-7):
        self.image = pygame.transform.scale(bullet_img, (100, 30))
        self.x = x + 20
        self.y = y
        self.speed = speed
        self.active = True
...
class MasterEnemy:
    def __init__(self):
        self.image = pygame.transform.scale(boss_img, (250, 250))
        self.x = WIDTH // 2 - 50
        self.y = 50
        self.speed = 2
        self.health = 500
    ...
    def run(self):
        while self.running:
            ...
            if self.master_enemy and self.master_enemy.health <= 0:
                self.display_message("You Won!", f"Total Points: {self.enemy_count}")
                self.running = False
